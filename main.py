...
with st.sidebar.beta_expander("Emblem Calculations"):
    if ec.ncdnormalemb + ec.nbatknormalemb + ec.natkpnormalemb != nec.normal_emb:
        st.write("Unable to find optimal combination. Please increase max damage cap to find combination.")
    else:
