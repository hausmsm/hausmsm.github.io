class link:
    def __init__(self):
        ...
        self.acc = 0
        self.accp = 4 #Marksman
        self.evd = 0
        self.evdp = 0
        self.penrate = 4 #Paladin
        self.block = 0
        self.abnormalstatres = 6 #Battle Mage, Mechanic, Wild Hunter
        ...
        self.meso = 0
        self.glincrease = 0
        self.partyexp = 4 #Bishop
        self.feverchargeinc = 4 #Aran
        self.feverduration = 5 #Blaze Wizard
