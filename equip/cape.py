class cape:
    def __init__(self, equip_type, stattype, character_class):
        self.emplist = {"1", "3", "4"}
        ...
        if self.equip_type in self.emplist:
            self.pdef += 958.1 + 548 + 0 # SF VALUE TO BE ADDED
            self.mdef += 958.1 + 548 + 0 # SF VALUE TO BE ADDED
            self.mp += 6021
            if self.stattype in self.normallist:
                if self.character_class == "WA":
                    self.evd += 1000
                else:
                    self.cr += 3
        ...
        # Necro
            ...
            self.pdef += 1344.2 + 667 + 0  # SF VALUE TO BE ADDED
            self.mdef += 2700.1 + 667 + 0  # SF VALUE TO BE ADDED
            self.mp += 6503
            if self.stattype in self.normallist:
                if self.character_class == "WA":
                    self.evd += 1000
