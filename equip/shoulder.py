class shoulder:
    def __init__(self, equip_type, stattype):
        ...
        if self.equip_type in self.emplist:
            self.pdef += 2882.1 + 1647 + 0 # SF VALUE TO BE ADDED
            self.mdef += 2882.1 + 1647 + 0 # SF VALUE TO BE ADDED
            self.mp += 3010
        ...
        # Necro
            ...
            self.pdef += 4045.6 + 2005 + 0  # SF VALUE TO BE ADDED
            self.mdef += 4045.6 + 2005 + 0  # SF VALUE TO BE ADDED
            self.mp += 3251
            if self.stattype in self.normallist:
                self.cratk += 300
            elif self.stattype in self.explist:
