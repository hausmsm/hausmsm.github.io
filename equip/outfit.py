class outfit:
    def __init__(self, equip_type, stattype):
        ...
        if self.equip_type in self.emplist:
            self.pdef += 4807.7 + 2750 + 0 # SF VALUE TO BE ADDED
            self.mdef += 4807.7 + 2750 + 0 # SF VALUE TO BE ADDED
            self.hp += 20720
        ...
        # Necro
            ...
            self.pdef += 6752.5 + 3347 + 0  # SF VALUE TO BE ADDED
            self.mdef += 6752.5 + 3347 + 0  # SF VALUE TO BE ADDED
            self.hp += 22377
            if self.stattype in self.normallist:
                self.evd += 680
            elif self.stattype in self.explist:
